...
* @param
*/
public static void isFuelTankEmptyTests(Car mine, double carFuelTankLevel)
{
    if(mine.isFuelTankEmpty(carFuelTankLevel) == true)
    {
